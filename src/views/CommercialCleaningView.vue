...
<div class="bg-white light:white dark:bg-white px-0 flex flex-col justify-center h-full w-full p-8 md:px-0 md:flex-col md:pt-0 lg:flex-row lg:w-full lg:pt-2 lg:pb-5 lg:px-0">
    ...
    <div class="w-full md:w-3/5 lg:w-full relative">
...
<div class="bg-white dark:bg-white light:bg-white flex flex-col justify justify-center h-1/2 w-full p-8 md:flex-col md:justify-center lg:flex-row lg:pt-10 lg:w-full lg:pb-10">
    ...
    <div class="bg-lightgray p-4 md:p-6 w-full md:w-3/5 lg:w-1/2 lg:px-10">
        <p class="text-gray dark:text-gray text-sm tracking-wider md:text-sm font-base pt-5 pb-2 lg:pt-16 lg:text-sm lg:font-semibold lg:tracking-wider">ERHVERVSRENGØRING</p>
...
<div class="bg-white dark:bg-white light:bg-white pt-4 flex flex-col justify justify-center h-1/2 w-full md:flex-col lg:flex-row lg:w-full lg:pt-2 lg:pb-16 lg:mx-0">
    <div class="bg-lightgray p-4 md:px-20 lg:pl-20 w-full md:w-full lg:w-full lg:m-0 lg:py-10">
        ...
        <div class="lg:w-1/3">
            ...
            <div class="font-sans text-black text-sm dark:text-black text-semibold text-sm lg:text-base lg:pt-3 lg:pl-9 lg:pr-5">
