...
<div class="bg-white dark:bg-white light:bg-white flex flex-col justify justify-center h-1/2 w-full p-8 pt-0 md:p-0 md:flex-col lg:flex-row lg:w-full lg:pt-3 lg:pb-16">
