...
<section class="relative h-full flex flex-col items-center text-center content-start pt-10 py-12 lg:py-12">
    ...
    <div class="flex justify justify-center flex-col lg:flex-row lg:space-x-0 lg:pt-5 lg:w-3/4 z-20 lg:pt-24">
        ...
        <div class="h-48 bg-lightblue light:bg-lightblue dark:bg-lightblue md:h-60 lg:h-96 lg:w-1/3 lg:justify-start lg:text-left">
            ...
            <p class="text-black lg:text-black lg:text-sm lg:px-8 lg:pt-2"> Ønsker du at kontakte mig pr. telefon, over mail eller facebook er du også meget velkommen til at gøre dette.</p>
