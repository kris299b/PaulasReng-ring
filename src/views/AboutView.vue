...
<section>
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center">
        <h1 class="text-white text-xs pb-2 pt-20 md:pb-4 md:text-xl lg:text-xl lg:pb-6 lg:pt-0">OM FIRMAET</h1>
        <p class="text-white text-base md:text-4xl md:pb-2 lg:text-5xl lg:pb-2">PAULAS RENGØRING</p>
    </div>
</div>
</section>
