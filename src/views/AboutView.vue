...
<!-- Værdisæt section -->
<div class="bg-white dark:bg-white light:bg-white flex flex-col justify justify-center h-1/2 w-full p-8 md:pt-12 md:flex-row lg:flex-row lg:w-full lg:pt-20 lg:pb-5">
...
<div class="flex justify bg-white dark:bg-white light:bg-white justify-center text-center max-h-40 w-full md:pt-5 lg:pb-6">
    <div class="w-full md:h-20">
        <h1 class="font-semibold text-black pt-4 text-lg pb-1 text-left px-8 md:text-xl md:pb-2 lg:text-2xl lg:text-center lg:pt-8">PAULAS RENGØRING</h1>
        <p class="text-sm text-black px-4 text-left px-8 lg:text-center lg:text-lg">Hos mig får du topkvalitet, der er bygget op på mange års erfaring og professionalisme.</p>
    </div>
</div>
...
<div class="bg-white dark:bg-white light:bg-white flex flex-col justify justify-center h-1/2 w-full p-8 md:flex-row lg:flex-row lg:w-full">
    ...
    <div class="bg-lightgray p-4 md:p-6 md:w-1/2 lg:w-1/2 lg:px-10">
        ...
        <p class="text-black text-sm pb-2 font-semibold md:pb-3 md:font-semibold lg:pb-0 lg:font-semibold lg:text-base">Jeg har mange års erfaring med privat og erhvervsrengøring, så du som kunde kan føle dig i trygge hænder, og altid regne med topkvalitet.</p>
...
<div class="bg-white dark:bg-white light:bg-white flex flex-col justify justify-center h-1/2 w-full pb-20 p-8 pt-0 md:p-0 md:flex-row lg:flex-row lg:w-full lg:pb-16">
