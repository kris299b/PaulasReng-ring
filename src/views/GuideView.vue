...
<section class="relative flex flex-col pt-5 h-[50vh] md:h-[40vh] lg:h-[80vh]">
    ...
    <div class="image-content z-10 pt-28 md:pt-40 md:px-10 lg:pt-48 lg:px-40">
        <div>
            ...
            <h2 class="font-sans text-white dark:text-white text-left font-semibold px-4 text-4xl md:text-5xl md:text-left lg:pb-2 lg:font-semibold lg:text-5xl lg:text-left">Få mest ud af din professionelle rengøringshjælp</h2>
        </div>
    </div>
</section>
...
<div class="flex bg-white dark:bg-white light:bg-white flex flex-col justify justify-center w-full pt-20 md:pt-5 md:flex-row md:justify-end lg:flex-row lg:w-full lg:pb-0 lg:mx-auto lg:justify-end">
    ...
    <div class="w-full p-4 md:w-2/4 lg:w-2/4 md:pt-10 md:pl-10 lg:pl-8 lg:pt-16 lg:pr-8 bg-lightgray">
        <h1 class="text-black font-semibold text-2xl pb-2 md:text-2xl lg:text-2xl md:pt-2 lg:pt-0">Book et formøde</h1>
        <p class="text-black text-sm font-semibold md:text-base md:pr-5 md:pb-3 md:font-semibold lg:font-semibold">Det er altid en god idé at booke et formøde, hvor du får lejlighed til at snakke med den person der skal stå for rengøringen af dit hjem.</p>
        <p class="text-black text-sm pt-2 md:text-base pb-1 md:pr-5 lg:pt-2 lg:text-base">Det er dit hjem, og du skal føle dig tryg i samarbejdet. Personen som skal hjælpe dig med rengøringen, får mulighed for at se dit hjem inden samarbejdet bliver sat i gang, og det vil give en god fornemmelse af, hvor meget tid der skal sætte af til de opgaver, du ønsker hjælp til. </p>
    </div>
</div>
...
<div class="flex bg-white dark:bg-white light:bg-white flex flex-col justify justify-center w-full pt-20 pb-8 md:flex-row md:justify-end lg:flex-row lg:w-full lg:pb-10 lg:mx-auto lg:justify-start">
    <div class="w-full p-4 md:w-2/4 lg:w-2/4 md:pt-10 md:pl-8 lg:pl-8 lg:pt-20 lg:pr-8 bg-lightgray">
        ...
        <p class="text-black text-sm pt-2 md:text-base md:pr-5 lg:pt-2 lg:text-base">Det er ønsker og krav I sammen vil gennemgå, og få til at passe ind i dine behov. Det er rart for begge parter, at der er en plan at holde sig til. Det vil selvfølgelig være en plan der kan ændre sig, alt efter dine ønsker. Det er dine behov og ønsker, der er i centrum.</p>
    </div>

    <div class="md:w-2/4 lg:w-1/4">
        <img src="../assets/arbejdsplan-billede-guide.jpg" alt="Kvinde udarbejder en arbejdsplan">
    </div>
</div>

<!--Box 3-->
<div class="flex bg-white dark:bg-white light:bg-white flex flex-col justify justify-center w-full pt-16 md:pt-10 md:flex-row md:justify-end lg:flex-row lg:w-full lg:pb-0 lg:mx-auto lg:justify-end">
    <div class="md:w-2/4 lg:w-1/4">
...
<div class="flex bg-white dark:bg-white light:bg-white flex flex-col justify justify-center w-full pt-20 md:flex-row md:justify-end lg:flex-row lg:w-full lg:pb-10 lg:mx-auto lg:justify-start">
    <div class="w-full p-4 md:w-2/4 md:pt-5 md:pl-8 lg:w-2/4 lg:pl-8 lg:pt-16 lg:pr-8 bg-lightgray">
        <h1 class="text-black font-semibold text-2xl pb-2 md:text-2xl lg:text-2xl md:pt-12 lg:pt-0">Skal jeg være hjemme?</h1>
        <p class="text-black text-sm font-semibold md:text-base md:pr-5 md:pb-3 md:font-semibold lg:font-semibold">Ønsker du at være hjemme når rengøringshjælpen kommer, eller har du andre ærinder du vil foretage dig imens?</p>
        <p class="text-black text-sm pt-2 md:text-base pb-2 md:pr-5 lg:pt-2 lg:text-base">Det er helt op til dig, om du ønsker at være hjemme mens rengøringsopgaverne bliver udført, og er noget som enhver rengøringshjælp skal respektere. Det handler om hvad der gør dig tryg, og hvad du har det bedst med. </p>
    </div>
...
<div class="bg:white light:bg-white dark:bg-white pt-10 pb-10 md:pt-20 lg:pb-20">
    <div class="bg:lightgray dark:bg-lightgray font-sans text-black dark:text-black md:px-6 lg:text-center lg:pt-10 lg:pb-10 lg:px-16 lg:text-3xl">
        <h2 class="text-left font-semibold pl-5 px-10 text-2xl pt-10 md:text-center lg:text-center lg:text-3xl lg:font-semibold">Husk at din rengøringshjælp går ind under ''Servicefradrag''</h2>
        <p class="text-left pl-5 pr-5 pt-3 pb-10 md:text-center lg:text-center lg:pt-4 lg:text-base">
            Når du køber privat rengøring, skal du huske at gemme alle dine kvitteringer. 
            ...
            Hold dig opdateret på SKAT i forhold til gældende regler.
        </p>
    </div>
</div>
...
<div class="bg-white dark:bg-white light:bg-white pt-6 pb-20 flex flex-col justify justify-center w-full p-8 pt-0 md:items-center md:p-0 md:pt-10 md:pb-20 md:flex-col lg:flex-row lg:w-full lg:pb-20">
    <div class="bg-lightgray p-4 pt-0 md:p-6 md:pb-0 md:w-3/5 lg:w-2/3 lg:px-12">
        <p class="text-gray dark:gray text-sm tracking-wider pt-8 font-semibold pb-1 md:pt-2 lg:text-sm lg:pt-12 lg:tracking-wider">OM MIG</p>
        ...
        <div class="row pt-2 pb-4 md:flex lg:flex md:pt-3 lg:pt-8 lg:pb-10">
