...
<div class="bg:white light:bg-white dark:bg-white pt-10 pb-10 md:pt-20 lg:pb-20">
    <div class="bg:lightgray dark:bg-lightgray font-sans lg:text-center lg:pt-10 lg:pb-10 lg:text-3xl text-black dark:text-black">
        ...
        <p class="text-left pl-5 pr-5 pt-3 pb-10 md:text-center lg:text-center lg:pl-40 lg:pr-40 lg:pt-4 lg:text-base">
...
<div class="bg-white dark:bg-white light:bg-white pt-6 pb-20 flex flex-col justify justify-center h-1/2 w-full p-8 pt-0 md:items-center md:p-0 md:pt-10 md:pb-20 md:flex-col lg:flex-row lg:w-full lg:pt-0 lg:pb-20">
