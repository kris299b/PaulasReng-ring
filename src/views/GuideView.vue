...
<section class="relative h-screen flex flex-col items-center py-20 text-center content-start lg:py-0 lg:h-[80vh]">
    ...
    <div class="image-content z-10 pt-40 md:pt-80 lg:pt-40">
        <div>
            <h1 class="text-white light:white dark:text-white text-xs text-left pb-2 pt-20 md:pb-4 md:text-xl lg:text-center lg:text-xl lg:pb-6 lg:pt-0">PAULAS RENGØRING | GUIDE</h1>
            <p class="text-white light:white dark:text-white text-base text-left md:text-4xl md:pb-2 lg:text-center lg:text-5xl lg:pb-2">Få mest ud af din professionelle</p>
            <p class="text-white light:white dark:text-white text-base text-left md:text-4xl md:pb-2 lg:text-center lg:text-5xl lg:pb-2">rengøringshjælp</p>
        </div>
    </div>
</section>
