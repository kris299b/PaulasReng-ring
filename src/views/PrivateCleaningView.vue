...
<!-- Tryghed-section -->
<div class="bg-white dark:bg-white columns-1 md:columns-1 lg:columns-2 lg:pt-20 lg:gap-x-0">
    <div class="bg-lightgray dark:bg-lightgray px-5 lg:px-20 lg:h-96">
        <p class="font-sans text-darkgray dark:darkgray text-sm pt-8 lg:text-sm lg:font-semibold lg:tracking-wider lg:pt-10">TRYGHED</p>
...
<div class="bg-white dark:bg-white px-5 columns-1 md:columns-2 lg:px-20 lg:columns-2 lg:gap-x-0 lg:pt-20 lg:pb-20 ">
    ...
    <div class="text-black dark:text-black lg:pt-10 lg:px-10 lg:text-xl">
       <h2 class="font-sans lg:font-semibold">PRIVATRENGØRING</h2>
       <p class="font-sans lg:text-sm lg:pt-3">Jeg tilbyder altid skræddersyede løsninger, som tager udgangspunkt i dine ønsker og behov.  </p>
       <p class="font-sans lg:text-sm lg:pt-3">Lad os tage en uforpligtigende snak om det, du har brug for hjælp til, og hvor ofte du har behov for rengøringshjælp. </p>
    </div>
</div>

<!-- Servicefradrag-section -->
<div class="bg:lightgray dark:bg-lightgray font-sans lg:text-center lg:pt-20 lg:pb-20 lg:text-3xl text-darkgray dark:text-darkgray">
    <h2 class="lg:font-semibold">Husk at din rengøringshjælp går</h2>
    <h2 class="lg:font-semibold">ind under ''Servicefradrag'' </h2>
...
<div class="bg-white dark:bg-white columns-1 md:gap-x-0 md:columns-2 lg:columns-2 lg:gap-x-0 lg:pt-5 lg:pb-20">
    <div class="bg-lightgray dark:bg-lightgray px-5 lg:px-20 lg:pb-20">
        <p class="font-sans text-gray dark:gray text-sm pt-8 md:px-2 md:pt-7 lg:text-sm lg:font-semibold lg:pt-20 lg:tracking-wider">PAULAS RENGØRING | FORLØBET</p>
