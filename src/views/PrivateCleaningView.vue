...
<div class="bg-white light:white dark:bg-white px-0 flex flex-col justify-center h-full w-full p-8 md:px-0 md:flex-row lg:flex-row lg:w-full lg:pt-10 lg:pb-5 lg:px-0">
    <div class="bg-beige light:bg-beige dark:bg-beige p-6 md:p-0 w-full md:w-full lg:w-full lg:px-12">
        ...
        <p class="text-black dark:text-black pt-2 pb-0 text-sm mt-3 font-base md:pt-0 md:font-base md:mx-5 md:text-sm lg:mx-0 lg:text-base lg:pt-2">Det er dit hjem, og dine ønsker samt behov der bliver centrum for vores samarbejde. Jeg respektere de rammer du sætter, og du kan stole på diskretion hos mig. </p>
...
<div class="bg:lightgray px-2 light:bg-lightgray dark:bg-lightgray font-sans md:px-10 lg:text-center lg:pt-10 lg:pb-10 lg:text-3xl text-black dark:text-black">
    ...
    <p class="text-base pl-5 pr-5 pt-3 pb-10 lg:text-center lg:pl-40 lg:pr-40 lg:pt-4 lg:text-base">
...
<div class="bg-white dark:bg-white light:bg-white pt-4 flex flex-col justify justify-center h-1/2 w-full md:flex-col lg:flex-row lg:w-full lg:pt-2 lg:pb-16 lg:mx-0">
    <div class="bg-lightgray p-4 md:px-20 lg:pl-20 w-full md:w-full lg:w-full lg:m-0 lg:py-10">
        ...
        <div class="lg:w-1/3">
            <div class="flex items-center pt-0 md:pt-6 lg:pt-0">
                <div>
            ...
            <div class="font-sans text-black text-sm dark:text-black text-semibold text-sm pt-2 lg:text-base lg:pt-3 lg:pl-9 lg:pr-5">
        ...
        <div class="lg:w-1/3">
            <div class="flex items-center pt-10 pb-2 md:pt-10 lg:pt-0">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="darkgray" class="w-6 h-6">
            ...
            <div class="font-sans text-black text-sm dark:text-black text-semibold text-sm lg:text-base lg:pt-0 lg:pl-9 lg:pr-5">
        ...
        <div class="lg:w-1/3">
            ...
            <div class="font-sans pb-10 text-black text-sm dark:text-black text-semibold text-sm lg:text-base lg:pt-0 lg:pb-0 lg:pl-9 lg:pr-5">
    ...
    <div class="grid grid-cols-1 gap-y-10 md:px-5 md:gap-x-5 md:grid-cols-3 lg:grid-cols-3 lg:gap-20 lg:px-20 lg:pb-20">
        <div class="max-w-xs mx-auto overflow-hidden shadow-lg bg-white dark:bg-white">
            <div class="px-6 py-10 flex flex-col items-center">
                ...
                <p class="font-sans text-darkgray text-base text-center text-base lg:text-base lg:text-darkgray lg:text-center lg:pt-2">
