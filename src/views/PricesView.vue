...
<div class="bg-white dark:bg-white light:bg-white flex flex-col justify justify-center h-1/2 w-full p-8 pt-10 md:pt-20 md:pb-10 md:flex-row lg:flex-row lg:w-full lg:pt-20 lg:pb-20">
    ...
    <div class="bg-lightgray p-4 md:p-6 md:w-1/2 md:pt-5 lg:w-2/5 lg:px-12">
        <p class="text-gray dark:gray text-xs pt-5 font-semibold pb-2 md:pt-12 lg:pt-6 lg:text-sm lg:tracking-wider">PRIS</p>
        <h2 class="text-black dark:text-black text-2xl font-semibold pb-4 lg:text-4xl">PAULAS RENGØRING </h2>
        <p class="text-black dark:text-black text-sm font-semibold pb-4 md:font-semibold lg:text-base lg:pt-1">Hos mig får du en kvalitetsbevidsthed samarbejdspartner, med en professionel tilgang til rengøringen. Mine værdier ligger fundamentet for samarbejdet. </p>
        <p class="text-black dark:text-black text-lg pb-2 font-semibold md:font-semibold md:pt-4 md:text-lg lg:font-semibold lg:text-xl lg:pt-4">Timepris</p>
        <p class="text-black dark:text-black text-sm pb-4 md:pt-0 lg:text-base lg:pt-1">Jeg kører med en fast timepris, hvor du som kunde altid er garanteret topkvalitet og professionalisme.</p>
        ...
        <p class="text-black dark:text-black pb-5 text-sm lg:text-base lg:pt-0 lg:pb-3">Ekskl. moms</p>
    </div>
</div>

<!-- Om sektion -->
<div class="bg-white dark:bg-white light:bg-white flex justify justify-center h-10 md:pt-0 lg:h-24">
